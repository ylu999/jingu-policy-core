...
exports.enforceReasoningFrame = enforceReasoningFrame;
const coherence_check_js_1 = require("./coherence-check.js");
/**
 ...
 */
function enforceReasoningFrame(input) {
    ...
    const coherence = (0, coherence_check_js_1.checkReasoningCoherence)(f);
