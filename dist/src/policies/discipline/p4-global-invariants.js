...
exports.p4GlobalInvariants = void 0;
 ...
 */
const p4GlobalInvariants = (input) => {
    const violations = [];
    ...
    const matchedQuickFix = QUICK_FIX_PATTERNS.find((p) => combinedText.includes(p));
    if (!matchedQuickFix)
        return violations;
...
exports.p4GlobalInvariants = p4GlobalInvariants;
